...
class _ManageExpensesScreenState extends State<ManageExpensesScreen> with SingleTickerProviderStateMixin {
            ...
            DropdownButtonFormField<String>(
              ...
              items: [
                ...
                const DropdownMenuItem(
                  value: 'Dukaan Kharcha Khata',
                  child: Text('Dukaan Kharcha Khata'),
                ),
                const DropdownMenuItem(
                  value: 'Commission Kharcha Khata',
                  child: Text('Commission Kharcha Khata'),
                ),
              ],
              onChanged: (value) {
                setState(() {
